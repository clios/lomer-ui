...
const RECIPES = [
  { name: 'accordion-disabled', dependencies: 'accordion' },
  { name: 'accordion-loading', dependencies: 'accordion' },
  { name: 'accordion-single-mode', dependencies: 'accordion' },
  { name: 'accordion-usage', dependencies: 'accordion' },
  { name: 'alert-closable', dependencies: 'alert' },
  { name: 'alert-custom-icon', dependencies: 'alert' },
  { name: 'alert-usage', dependencies: 'alert' }
];
...
export async function craftWithRecipe(recipe, fileName) {
  try {
