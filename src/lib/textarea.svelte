...
<div class="relative">
	<textarea
		class={twMerge(
			...
			'disabled:cursor-not-allowed disabled:resize-none disabled:outline-hidden', // visual
	...
	{#if isLoading}
		<svg
			class="absolute top-2 right-2 text-cyan-600 dark:text-cyan-500"
			width="22"
			height="22"
			viewBox="0 0 24 24"
		>
	...
	{:else if isDisabled}
		<svg
			class="absolute top-2 right-2 text-zinc-500"
			width="22"
			height="22"
			viewBox="0 0 24 24"
		>
