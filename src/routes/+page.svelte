...
<Shell>
    <LomerSection>
        ...
        <Flex class="my-4 flex-wrap gap-2">
            <div class="bg-general-500 rounded">
                <Button
                    href="/theming-structure"
                    class="from-primary to-primary/80 text-general-50 bg-gradient-to-r pr-2 pl-3"
                >
                    Get Started
    ...
    <LomerSection>
        <LomerTitle>Create these components from scratch.</LomerTitle>
    ...
    <LomerSection>
        <LomerTitle>Why not a library?</LomerTitle>
        <Paragraph>
            I believe that for simple components, it's more valuable to focus on learning how to write the code and
            understand the underlying concepts, rather than relying entirely on a library.
        </Paragraph>
        <Paragraph>
            By combining the simplicity of Svelte with the versatility of Tailwind CSS, we can build UI components that
            are both straightforward and fully customizable — with complete control over structure, style, and behavior.
        </Paragraph>
        <LomerTitle level={2}>More control</LomerTitle>
        <Paragraph>You’re not limited by a library’s rules. You write the code your way.</Paragraph>
        <LomerTitle level={2}>Custom designs</LomerTitle>
        <Paragraph>Tailwind makes it easy to create your own look without fighting against prebuilt styles.</Paragraph>
        <LomerTitle level={2}>Better performance</LomerTitle>
