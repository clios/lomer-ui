...
<h1 class="font-mono text-3xl font-bold">Input Select</h1>
<p>A component that looks like an input select.</p>
<Code code={`import { InputSelect } from 'lomer-ui'`} language="javascript" />
