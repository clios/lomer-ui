<script lang="ts">
    import AvatarRaw from '$lib/components/base/avatar.svelte?raw';
...
<svelte:head>
    <title>Lomer UI - Avatar</title>
</svelte:head>

<LomerSection>
    <p class="text-muted mb-2 text-xs">Component</p>
    <LomerTitle>Avatar</LomerTitle>
...
<LomerSection>
    ...
    <CardCLI code="npx lomer-ui get avatar" />
</LomerSection>
