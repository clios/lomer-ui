<script>
  ...
  const tickler = [
    {
      id: '1',
      label: "We don't do that here"
    }
  ];
</script>

<svelte:head>
  <title>Setup . lomer-ui</title>
</svelte:head>
...
>
  <PageSection id="1" title="We don't do that here">
    <PageArticle id="1.1">
      <p>We just run a command, and it just works.</p>
      <CopyCLI code="npx lomer-ui get [component/]" />
